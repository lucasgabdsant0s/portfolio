    ...
    <section className="py-16 md:py-24 px-4 pb-12 w-full max-w-6xl mx-auto border-t border-neutral-800/50 mt-12">
      <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
        ...
        >
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">{t.contact.client_title}</h3>
          ...
          <a href="https://wa.me/5511977134857" target="_blank" rel="noreferrer">
            <Button tabIndex={-1} className="w-full sm:w-auto h-14 px-8 text-base shadow-[0_0_20px_rgba(59,130,246,0.3)]">
              <MessageSquare className="w-5 h-5 mr-3" /> {t.contact.btn_whatsapp}
            </Button>
          </a>
        </motion.div>
        ...
        >
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">{t.contact.recruiter_title}</h3>
          <p className="text-sm sm:text-base text-neutral-400 mb-8 max-w-md">
