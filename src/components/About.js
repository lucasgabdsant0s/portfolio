...
const About = () => {
  ...
  return (
    <section
      id="sobre"
      className="py-20 bg-bg-secondary relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-6 text-lg text-secondary leading-relaxed">
                <p>
                  ...
                  <span className="text-accent-blue font-semibold">
                    {" "}
                    Node.js, React, PHP, MySQL, Tailwind e JavaScript
                  </span>
                  . Meu objetivo é transformar ideias em soluções digitais
                  funcionais, com foco em performance, usabilidade e código
                  limpo.
                </p>

                <p>
                Tenho facilidade em aprender e sou movido por desafios. Gosto de resolver problemas com lógica, escrever código limpo e criar soluções úteis e escaláveis. Estou sempre em evolução, estudando boas práticas e novas tecnologias. Meu objetivo é crescer como desenvolvedor, contribuir com projetos de impacto e trabalhar com times que me desafiem a ser melhor a cada dia.
                </p>
              </div>
            ...
            <div
              className="grid grid-cols-2 md:grid-cols-4 gap-4 fade-in-left"
              style={{ animationDelay: "0.2s" }}
            >
              {stats.map((stat, index) => (
                <div
                  key={stat.label}
                  className="card text-center group hover:scale-105 transition-all duration-300 p-4"
                >
          ...
          {/* Right content - Profile card compacto */}
          <div className="fade-in-right lg:col-span-1">
            <div className="relative">
              {/* Main profile card - Mais compacto */}
              <div className="relative p-6 card border-gradient glow-on-hover">
                {/* Profile avatar - Menor */}
                <div className="w-32 h-32 mx-auto mb-4 relative">
                  <div className="w-full h-full bg-gradient-to-br from-accent-blue via-accent-purple to-accent-green rounded-xl flex items-center justify-center shadow-lg">
                    <div className="text-white text-center">
                      <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto backdrop-blur-sm">
                  ...
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-accent-green rounded-full flex items-center justify-center shadow-lg animate-bounce">
                    <span className="text-white text-sm">✨</span>
                  </div>
                  <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-accent-blue rounded-full flex items-center justify-center shadow-lg animate-pulse">
                    <span className="text-white text-xs">🔥</span>
                  </div>
                </div>

                {/* Profile info - Compacto */}
                <div className="text-center">
                  <h4 className="text-xl font-bold text-white mb-1">
                    Lucas Gabriel
                  </h4>
                  <p className="text-accent mb-3 font-medium text-sm">
                    Desenvolvedor Full Stack
                  </p>

                  {/* Skills tags - Mais compactas */}
                  <div className="flex flex-wrap justify-center gap-1 mb-4">
                    {[
                      ...
                      <span
                        key={skill}
                        className="px-2 py-1 bg-white bg-opacity-10 text-muted rounded-full text-xs border border-white border-opacity-20 hover:border-accent transition-colors duration-300"
                      >
                        {skill}
                      </span>
                    ))}
                  ...
                  {/* Social links - Compactas */}
                  <div className="flex justify-center space-x-3">
                    <a
                      href="https://www.linkedin.com/in/lucas-dev-gabriel/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-8 h-8 bg-accent-blue bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-300"
                    >
                      <span className="text-accent-blue text-sm">💼</span>
                    </a>
                    <a
                      href="mailto:lucasgabdsantos@gmail.com"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-8 h-8 bg-accent-purple bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-300"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-8 h-8 bg-accent-green bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-300"
                    >
              ...
              {/* Decorative elements */}
              <div className="absolute -z-10 top-2 left-2 w-full h-full border border-accent-blue border-opacity-20 rounded-xl"></div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 text-center fade-in-up">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted mb-8 text-lg">
              Vamos transformar suas ideias em soluções digitais que fazem a
              diferença.
            </p>
